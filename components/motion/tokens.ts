...
/**
 * Shared motion vocabulary for Momentum. Keeping every spring and easing in one
 * place is what makes the app's motion feel like one designed system rather than
 * a pile of independently-tuned animations (DESIGN_DIRECTION.md — "Rich,
 * choreographed motion" with "spring-physics transitions").
 *
...
export const ease = {
  /** easeOutExpo-ish — decisive arrivals. */
  out: [0.22, 1, 0.36, 1],
